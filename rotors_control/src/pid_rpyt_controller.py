...
def data_handler(data):
    ...
    header="ThrottleDes_z; position_z; throttle ; position_x; position_y; RollDes; PitchDes; orientation_x; orientation_y; dRollDes; dPitchDes; YawRateDes; angularvelocity_x; angularvelocity_y; angularvelocity_z; ddRoll; ddPitch; ddYaw; current_time"

    #define the directory to save the data. 
    filename =rospy.get_namespace()[1:-1]+"_rpytcontroller_log"
